...
(splicing-local
  ((define rtd.mark    (make-rtd 'mark '#(#f) 'mark))
   ...
   (define rtd.annotated    (make-rtd 'syntax:annotated '#(#f #f) syntax-represent))
   ...
   (define rtd.marked    (make-rtd 'syntax:marked '#(#f #f) syntax-represent))

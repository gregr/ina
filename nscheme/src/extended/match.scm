(begin-meta
  ...
  (define vocab.match-pattern-quasiquote 'match-pattern-quasiquote)
  ...
  (define parse-pattern-quasiquote
    (make-parse-quasi
      vocab.match-pattern-quasiquote 'quasiquote 'unquote #f '... parse-pattern parse-pattern-quote $p:cons
      (lambda (P)
        ($p:vector
          (let loop ((P P))

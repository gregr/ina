...
(define (binding-vocabulary-remover id . v*)  (binding-vocabulary-remover* id v*))
...
(define ((binding-vocabulary-updater* id vu*)    v=>x) (binding-vocabulary-update* v=>x id vu*))
...
(define (env-vocabulary-set!* env id vx*)
  (env-bind! env id (binding-vocabulary-set* (or (env-ref env id) (make-binding id)) id vx*)))
(define (env-vocabulary-add!* env id vx*)
  (env-bind! env id (binding-vocabulary-add* (or (env-ref env id) (make-binding id)) id vx*)))
(define (env-vocabulary-remove!* env id vocab*)
  (env-bind! env id (binding-vocabulary-remove* (or (env-ref env id) (make-binding id)) id vocab*)))
(define (env-vocabulary-update!* env id vu*)
  (env-bind! env id (binding-vocabulary-update* (env-ref env id) id vu*)))

...
(define (env-vocabulary-set!* env id vx*)
  (let ((vocab=>x (env-ref env id)))
    (unless vocab=>x (mistake 'env-vocabulary-set! "unbound identifier" id))
    (env-bind! env id (binding-vocabulary-set* vocab=>x id vx*))))

...
(define (parse-pattern-list   env . stx*)          (foldr $p:cons ($p:quote '())
                                                          (parse-pattern* env stx*)))
...
;; TODO: check for ellipsis via auxiliary
(define (parse-pattern-quasiquote env stx)
  (raise-syntax-error "TODO: implement quasiquote patterns" stx))

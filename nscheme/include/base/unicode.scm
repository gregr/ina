...
(splicing-local
  ((define (utf8-decode-continuation b)
  ...
  (define (utf8-decode-2 b0 b1)
    ...
    (bitwise-ior (bitwise-asl (bitwise-and b0 #x1f) 6) (utf8-decode-continuation b1)))
  (define (utf8-decode-3 b0 b1 b2)
    (let ((c (bitwise-ior (bitwise-asl (bitwise-and b0 #x0f)  12)
                          (bitwise-asl (utf8-decode-continuation b1)  6)
                          (utf8-decode-continuation b2))))
  ...
  (define (utf8-decode-4 b0 b1 b2 b3)
    (let ((c (bitwise-ior (bitwise-asl (bitwise-and b0 #x0f)  18)
                          (bitwise-asl (utf8-decode-continuation b1) 12)
                          (bitwise-asl (utf8-decode-continuation b2)  6)
                          (utf8-decode-continuation b3))))

...
(splicing-local
  ((define cenv.empty '())
       ...
       (cond
         ...
         ((E:prim? E)
          (let ((p (caseq (E:prim-name E)
                     ...
                     ((set-thread-register!) set-thread-register!)
   ...
   (define (thread-register/k k . x*) (k (apply thread-register x*)))
   (define (set-thread-register!/k k . x*) (k (apply set-thread-register! x*)))
